...
5. run 'composer dump-autoload' to create autoload
6. run 'php artisan db:seed' to add seed data in database
7. run 'php artisan storage:link' to add storage link
