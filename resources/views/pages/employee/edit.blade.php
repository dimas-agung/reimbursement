                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input id="nip" type="text"
                                                ...
                                                value="{{ $employee->nip }}" required autocomplete="nip" autofocus required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input id="name" type="text"
                                                ...
                                                value="{{ $employee->name }}" required autocomplete="name" autofocus required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            value="{{ $employee->email }}" required autocomplete="email" autofocus required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
